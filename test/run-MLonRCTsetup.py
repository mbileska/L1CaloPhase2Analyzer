...
# Run L1 simulation
process.load("L1Trigger.L1CaloTrigger.l1tPhase2MLonRCTSetupProducer_cfi")
process.L1simulation_step = cms.Path(process.l1tPhase2MLonRCTSetupProducer)

# Run the analyzer
process.load('L1Trigger.L1CaloPhase2Analyzer.l1tMLonRCT_cfi')

process.RCT = cms.Path( process.l1tPhase2MLonRCTSetupProducer*process.l1NtupleProducer )
